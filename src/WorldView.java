...
public final class WorldView {
    ...
    public void shiftView(int colDelta, int rowDelta) {
        int newCol = NewEntity.clamp(this.viewport.getCol() + colDelta, 0, this.world.getNumCols() - this.viewport.getNumCols());
        int newRow = NewEntity.clamp(this.viewport.getRow() + rowDelta, 0, this.world.getNumRows() - this.viewport.getNumRows());
    ...
    public void drawEntities() {
        for (NewEntity entity : this.world.getEntities()) {
