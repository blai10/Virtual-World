...
public final class EventScheduler {
    ...
    private Map<NewEntity, List<Event>> pendingEvents;
    ...
    public void scheduleEvent(NewEntity entity, Action action, double afterPeriod) {
    ...
    public void unscheduleAllEvents(NewEntity entity) {
